                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span  class="dont_edit_posted_form span_posted_${response.data.task_id} ">${response.data.name_of_taskfor}</span>
                                        <select class="form-control edit_posted_form_${response.data.task_id} task_for_${response.data.task_id}" id="task_for_${response.data.task_id}" lang="${response.data.task_for_id}" value="${response.data.name_of_taskfor}" name="gender" style="display:none;" name="gender" >
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status == "200") {
                ...
                $("#comp_name").html(response.data.company_name);
                $("#comp_name_field").val(response.data.company_name);


                $("#contacts_status").html(response.data.active_status);
                $("#status").val(response.data.active_status);

                // $("#comp_name").html(response.data.company_name);
                // $("#comp_name_field").val(response.data.company_name);

                $("#comp_description").html(response.data.company_description);
                $("#comp_descr_field").val(response.data.company_description);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status == "200") {
                    ...
                    $.each(response["data"], function (i, v) {
                       ...
                       strTable +=`<li class="for_hover1" id="for_hover_${v.task_id}" style="border-radius: 10px; margin-bottom:5px; border-right:${v.progress_status == "Pending" ? "5px solid darkorange" :
                        ...
                        <a class="arrow-down" id="arrow_down_${v.task_id}"><i class="fa fa-arrow-up blob green" aria-hidden="true" style="font-size: 20px; margin-top: 3px;color: rgba(51, 217, 178, 1);
                          "></i></a>
                          <li style="float: right; display:flex;"><a class="edit_posted_task" id="show_pen_${v.task_id}"><i class="fa fa-pencil" style="color: #f55b5b"></i></a>
                ...
                strTable = '<tr><td colspan="8">' + response.data.msg + "</td></tr>";
                ...
                // alert(response.msg);
                strTable += "<tr>";
                strTable += '<td colspan="8">' + response.data.msg + "</td>";
                strTable += "</tr>";
