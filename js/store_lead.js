                       ...
                       strTable +=`<li class="for_hover1" id="for_hover_${v.task_id}" style="border-radius: 10px; margin-bottom:5px; border-right:${v.progress_status == "Pending" ? "5px solid darkorange" :
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                //     <td style="width: 20%"><b>Task For:</b></td>
                                //     <td>
                                //         <span  class="dont_edit_posted_form span_posted_${v.task_id} ">${v.name_of_taskfor}</span>
                                //         <select class="form-control edit_posted_form_${v.task_id} task_for_${v.task_id}" id="task_for_${v.task_id}" lang="${v.task_for_id}" value="${v.name_of_taskfor}" name="gender" style="display:none;" name="gender" >
                                //             <option value="117" selected>Ugochukwu Nwagba</option>
                                //         </select>
                                //     </td>
                                // </tr>
