$(document).ready(function() {
    ...
    $(document).on('click', "#update_details__", function(){
     ...
     $(document).on('click', "#update_company_details", function(){
        const urlParams = new URLSearchParams(window.location.search);
        const client_id = urlParams.get('id'); // johnny
    ...
    // });
     ...
     $(document).on('click', ".for_hover", function(){
...
function update_company_details(){
    ...
    var company_description = $("#company_description_field").val();
    ...
    var company_website = $("#company_website_field").val();
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.data.status == "200") {
                ...
                $("#update_company_details").show();//show update button
...
function update_contact_details(client_id){
    ...
    $.ajax({
        ...
        url: api_path + "crm/update_contact_info",
...
function fetch_client_details(){
    ...
    $.ajax({
        ...
        url: api_path + "crm/get_client_info",
        data: { company_id: company_id, client_id: client_id, user_id: user_id },
        ...
        success: function (response) {
            ...
            if (response.status == "200") {
                ...
                $("#company_name_field").val(response.data.company_name);

                $("#company_description").html(response.data.company_description);
                $("#company_description_field").val(response.data.company_description);

                $("#company_email").html(response.data.company_email);
                $("#company_email_field").val(response.data.company_email);

                $("#company_phone").html(response.data.company_phone);
                $("#company_phone_field").val(response.data.company_phone);

                $("#company_address").html(response.data.company_address);
                $("#company_address_field").val(response.data.company_address);

                $("#company_website").html(response.data.company_website);
                $("#company_website_field").val(response.data.company_website);
                ...
                $("#contacts_dob").html(response.data.contacts_dob);
                ...
                $("#contacts_dob_field").val(response.data.contacts_dob);

                $("#date_inserted").html(response.data.date_inserted);
                // $("#lead_stage").html(response.data.lead_stage_name);
                         ...
                         "5px solid darkred" }">
                            <div class="block">
                              ...
                              <div class="block_content">
                                ...
                                <div class="for_one" id="for_one_${client_id}" style="display:none;">
                                           <div class="x_title" style="border:none;">
                        <h2>Task<!-- <small>Sessions</small> --></h2>
                        <ul class="nav navbar-right panel_toolbox" style="">
                        <a class="arrow-down" id="arrow_down_${client_id}"><i class="fa fa-arrow-up blob green" aria-hidden="true" style="font-size: 20px; margin-top: 3px;color: rgba(51, 217, 178, 1);
                          "></i></a>
                          <li style="float: right; display:flex;"><a class="edit_posted_task" id="show_pen_${client_id}"><i class="fa fa-pencil" style="color: #f55b5b"></i></a>
                          <a class="delete_task" id="show_del_${client_id}"><i class="fa fa-times" style="color: #f55b5b"></i></a>
                          </li>
                        </ul>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="contacts_firstname" class="dont_edit_posted_form span_posted_${client_id}">${response.data.task_type}</span>
                                        <select class="form-control edit_posted_form_${client_id} task_type_${client_id}" id="contacts_firstname_field_${client_id}" value="${response.data.task_type}" name="gender" style="display:none;">
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <span  class="dont_edit_posted_form span_posted_${client_id} ">${response.data.task}</span>
                                        <input type="text" style="display:none;" class="form-control task_title_${client_id} edit_posted_form_${client_id}" value="${response.data.task}" id="contacts_tasktitle_field_${client_id}" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span  class="dont_edit_posted_form span_posted_${client_id} ">${response.data.name_of_taskfor}</span>
                                        <select class="form-control edit_posted_form_${client_id} task_for_${client_id}" id="task_for_${client_id}" lang="${response.data.task_for_id}" value="${response.data.name_of_taskfor}" name="gender" style="display:none;" name="gender" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span  class="dont_edit_posted_form span_posted_${client_id}">${response.data.description}</span>
                                         <textarea style="display:none;"  class="form-control task_description_${client_id} edit_posted_form_${client_id}" value="${response.data.description}" id="main_task_${client_id}" >${response.data.description}</textarea>
                                    </td>
                                    <!-- <td>@twitter</td> -->
                                </tr>
                                  <tr>
                                    ...
                                    <td>
                                        <span  class="dont_edit_posted_form span_posted_${client_id}"> ${response.data.date_created}</span>
                                        <input style="display:none;" type="datetime-local" class="form-control date_created_${client_id} edit_posted_form_${client_id}" value="${response.data.start_date.split('+')[0]}" id="contacts_tasktitle_field_${client_id}" >
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <span  class="dont_edit_posted_form span_posted_${client_id}">${response.data.finished_date_non_iso}</span>
                                        <input style="display:none;" type="datetime-local" class="form-control finished_date_${client_id} edit_posted_form_${client_id}" value="${response.data.finished_date.split('+')[0]}" id="contacts_tasktitle_field_${client_id}" >
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <span class="dont_edit_posted_form span_posted_${client_id}">${response.data.progress_status}</span>
                                        <select style="display:none" class="form-control edit_posted_form_${client_id} task_status_${client_id}" value="${response.data.progress_status}"  id="contacts_firstname_field1_${client_id}" name="gender">
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ${response.data.files ? display_files(response.data.files) : `<span class="dont_edit_posted_form span_posted_${client_id}">No file</span>`}

                                        <span class="dont_edit_posted_form"></span>
                                        <input style="display: none;" type="file" class="form-control edit_posted_form_${client_id}" id="contacts_tasktitle_field_${client_id}" >
                                    </td>
                                    <!-- <td>@twitter</td> -->
                                </tr>
                                  <tr id="buttons_for_task_edit1_${client_id}" style="display:none">
                                    <td></td>
                                    <td>
                                        <div id="error_msg" style="color: red; display: "></div>
                                        <i class="fa fa-spinner fa-spin fa-fw fa-3x" style="display: none;" id="loader_${client_id}"></i>
                                        <button type="button" class="btn btn-primary post_task_" id="post_task_${client_id}">Post Task</button>
                                        &nbsp;
                                        <button type="button" class="btn btn-danger cancel_task_update" id="cancel_task_update_${client_id}">Cancel Update</button>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <div class="hover_here" id="show_fields_${client_id}">
