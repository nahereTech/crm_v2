	   ...
	   /* CUSTOM NOTIFICATION */
		...
		function init_echarts() {
			...
			if ($('#yearly_sales_report').length ){
                ...
                type: "POST",
                dataType: "json",
                url: api_path+"wms/monthly_sales_rpt",
			  ...
			  var echartBar = echarts.init(document.getElementById('yearly_sales_report'), theme);
			...
			if ($('#yearly_expense_report').length ){
                ...
                type: "get",
                dataType: "json",
                url: api_path+"crm/monthly_crm_revenue",
                data: {"company_id": company_id},
                timeout: 60000,
                    ...
                    if (response.status == '200'){
						...
						if(response.data.list.length != 0){
	                        ...
	                        $(response.data.list).each(function(index, value){
						  	...
						  	var echartBar = echarts.init(document.getElementById('yearly_expense_report'), theme);
                ...
                success: function(response) {
                    ...
                    if (response.status == '200'){
						...
						if(response.data.list.length != 0){
						  ...
						  var echartBar = echarts.init(document.getElementById('crm_revenue_year'), theme);
			...
			if ($('#echart_line_445').length ){ 
			  
			  var echartLine = echarts.init(document.getElementById('echart_line_445'), theme);
			...
			// 	  x: 'center',
			// 	  y: 'bottom',
			// 	  data: ['Ikeja', 'Ilupeju', 'Union Ad', 'Video Ads', 'Search Engine']
			// 	},
			// 	toolbox: {
			// 	  show: true,
			// 	  feature: {
                ...
                success: function(response) {
                    ...
                    if (response.status == '200'){
                        ...
                        $(response.data.warehouse).each(function(index, value){
                          // alert(index)
                          list_of_names.push( value.name );
                          list_of_values.push({ value: Number(value.cost), name: value.name});

                        });
					
			  	// alert(list_of_values)
			  var echartPie = echarts.init(document.getElementById('warehouse_pie'), theme);
