            ...
            <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group" style="float: right">
                        <a href="clients"><button type="button" class="btn btn-success">Back</button></a>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <!-- <ul class="nav navbar-right panel_toolbox">
                          ...
                          <li><a class=""><i class="fa fa-plus" style="color: green;"></i></a>
                          </li>
                        </ul> -->
                        <ul class="nav navbar-right panel_toolbox">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="contacts_firstname" class="dont_edit"></span>
                                        <input type="text" class="form-control edit_info_form" id="contacts_firstname_field" style="display: none">
                                    </td>
                                    <!-- <td>@twitter</td> -->
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="contacts_lastname" class="dont_edit"></span>
                                        <input type="text" class="form-control edit_info_form" id="contacts_lastname_field" style="display: none">
                                    </td>
                                    <!-- <td>@twitter</td> -->
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="contacts_phone" class="dont_edit"></span>
                                        <input type="text" class="form-control edit_info_form" id="contacts_phone_field" style="display: none">
                                    </td>
                                    <!-- <td>@twitter</td> -->
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="contacts_email" class="dont_edit"></span>
                                        <input type="text" class="form-control edit_info_form" id="contacts_email_field" style="display: none">
                                    </td>
                                    <!-- <td>@twitter</td> -->
                                </tr>
                                ...
                                <tr>
                                    <!-- <th scope="row">3</th> -->
                                    <td><b>Contact's Date of Birth:</b></td>
                                    <td>
                                        <span id="contacts_dob" class="dont_edit"></span>
                                        <input type="text" class="form-control edit_info_form" id="contacts_dob_field" style="display: none">
                                    </td>
                                    <!-- <td>@twitter</td> -->
                                </tr>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <!-- <th scope="row">1</th> -->
                                    <td style="width: 20%"><b>Client Name/Company's name:</b></td>
                                    <td>
                                        <span id="comp_name" style="cursor: pointer;" class="non_comp_editable"></span>
                                        <input type="text" class="form-control edit_comp_info_form" id="comp_name_field" style="display: none">
                                    </td>
                                </tr>
                                <tr>
                                    <!-- <th scope="row">2</th> -->
                                    <td><b>Client Description/Company's Description:</b></td>
                                    <td>
                                        <span id="comp_description" class="non_comp_editable"></span>
                                          <input type="text" class="form-control edit_comp_info_form" id="comp_descr_field" style="display: none;">
                                    </td>
                                </tr>
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <span id="contacts_status" class="non_comp_editable">Call</span>
                                        <select class="form-control edit_comp_info_form" id="status" name="gender" style="display: none;" >
...
<script src="js/client_page.js?v=10189"></script>
<?php
